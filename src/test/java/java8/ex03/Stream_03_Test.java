...
public class Stream_03_Test {
	...
	public void test_joining() throws Exception {
		...
		// TODO construire une chaîne contenant les prénoms des clients triés et séparé
		// par le caractère "|"
	...
	public void test_mapping() throws Exception {
		...
		// utilisation de la mergeFunction pour écrire nom|nom2
		Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(
				Collectors.toMap(Customer::getGender, s -> s.getFirstname(), (nom1, nom2) -> nom1 + "|" + nom2));
